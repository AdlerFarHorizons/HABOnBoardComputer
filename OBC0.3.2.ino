...
unsigned long lastIMUPmillis=0,lastIMUOmillis=0,lastIMUMmillis=0;
...
char logString[200];
sprintf(logString,"$STATE %ld %ld %2d %02d %5.2f %4d %5.2f %4d %5.2f %8.1f %ld %6.2f %6.2f %6.2f %ld %6.2f %6.2f %ld %5d %5d %5d\n", 
